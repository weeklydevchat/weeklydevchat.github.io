...
![Azal Abedi](azal.webp){: style="width:150px;float: left;padding-right: 10px;"}
...
![Hugo Palomera](hugo.webp){: style="width:150px;float: left;padding-right: 10px;"}
...
![Dale Hagglund](dale.webp){: style="width:150px;float: left;padding-right: 10px;"}
...
![Brim Wais](birm.webp){: style="width:150px;float: left;padding-right: 10px;"}
